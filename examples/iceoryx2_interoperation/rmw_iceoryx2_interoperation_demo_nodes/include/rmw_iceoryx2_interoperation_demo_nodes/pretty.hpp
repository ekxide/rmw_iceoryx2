...
#ifndef RMW_ICEORYX2_INTEROPERATION_DEMO_NODES_PRETTY_HPP
#define RMW_ICEORYX2_INTEROPERATION_DEMO_NODES_PRETTY_HPP
...
// string is appended to the header line (the subscriber uses it for the
// sequence number; the publisher leaves it empty). A leading newline lets the
// frame start on a fresh line below the logger prefix so its borders align.
//
//   ╭─ RECV · seq 42
//   │  x             42
//   │  funky         34109.04
...
#endif // RMW_ICEORYX2_INTEROPERATION_DEMO_NODES_PRETTY_HPP
